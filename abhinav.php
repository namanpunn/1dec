...
$zappit_auth_token = "eyJhbGciOiJSUzI1NiIsImtpZCI6IjNmZDA3MmRmYTM4MDU2NzlmMTZmZTQxNzM4YzJhM2FkM2Y5MGIyMTQiLCJ0eXAiOiJKV1QifQ..nasPgjalV8zhtBH_4_7ksV4gYVl-Igc1ay0rvOLP-hNoyp31bIeBEHNlYNIP6qh5h4FQ2EsAWoXKcJ3IKXwqiFcKWSMWjFGzEpeTGvIoVPvCXsUQdsrggGskn5feqG5mRo0CVYna2_P-g60F8J0vXqti-DNfy3WdAvu7edLLkBY7NQMqSeKjIuEPfjuxUoL4kRCELWRUTx6BKaXJRcoUt_wiDj2ljzsiuaSKNnd9H-JxPi-cxCF2L6gn7iSDJ14tdN7vROVDKE88UvQhgUIAwxsMIy1s6N-DMJr-8xRKYGfQWm-Bt4Z3U-QJkSS42n-sX8QiFUY1Jn5Y8NqnlxiMUg";
                    ...
                    <tr class="bg-white border-t border-gray-200 hover:bg-[#F3F7FD] transition-colors duration-300">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex justify-center space-x-2">
                                <div id="technicalDrawer-${item.page_id}-${<?php echo  create_slug_(?> item.desc<?php ); ?>}" class="fixed top-0 left-0 w-full h-full bg-gray-900 bg-opacity-50 flex items-center justify-center opacity-0 pointer-events-none transition-opacity duration-300">
