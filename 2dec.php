...
$zappit_auth_token = "eyJhbGciOiJSUzI1NiIsImtpZCI6IjNmZDA3MmRmYTM4MDU2NzlmMTZmZTQxNzM4YzJhM2FkM2Y5MGIyMTQiLCJ0eXAiOiJKV1QifQ..JRIdHv6yoaXTreH9_p2jGg_AFcvq2vdDjVMWFLeqlYIExUL5zgDNm5H2DZyy3FD9WROlrLB_op2W-cKQQAkEV3ASvOmyS_PSb5CiF2jdNcxgT7mG5cc3OjW9fqrt5EftrpKiL3qSBrRBmLiO1RrRr5qmgaFCezSlXfm_3-sUoaDbR89mG5645IIJJZH0GfphtItMdd-TnjL94FlT5QtaN9p05JC_SxhOggydTfGGIbyZ5bCXQXlLUIBC90V1MsJWN1N64SjHj7tGo9IboejhRkrvpHpHFK-yKhi9MLwDPvzVVgH22em7oFhjY68S_mgd92dR9_YeesredokbNlgong";
...
function display_page_fixes_table($meta_key)
{
    ...
    <div class="overflow-x-auto">
        ...
        <div id="page-pagination-controls" class="flex items-center gap-4 p-4 bg-gray-100 rounded-lg shadow-md">
    <!-- Previous Button -->
...
class ServerSidePagination {
  ...
  async fetchData() {
    try {
        ...
        // Extract pageFixes category data
        const items = data.pageFixes || [];
        const hasMore = data.hasMore?.pageFixes || false;
...
renderData(items) {
    ...
    // Create a container for item list
    const listContainer = document.createElement('div');
    listContainer.classList.add('items-list');

    // Render each item (only for the current page)
    items.forEach((pageitem, index) => {
        console.log(`Rendering item ${index}:`, pageitem);

        const itemElement = document.createElement('tr');
        itemElement.classList.add('pagination-item', 'border-b');

        // Convert `lastCreatedAt` to a human-readable date
        const lastCreatedAt = pageitem.lastCreatedAt?.pageFixes
            ? new Date(pageitem.lastCreatedAt.pageFixes._seconds * 1000).toLocaleString()
            : 'N/A';

        // Render with id, description, and "last created at" information
        itemElement.innerHTML = `
            <td class="px-6 py-4 text-left">${pageitem.id || 'N/A'}</td>
            <td class="px-6 py-4 text-center">
                <span class="inline-block px-2 py-1 bg-blue-100 text-blue-800 rounded-full">
                    ${pageitem.recommendationType || 'N/A'}
                </span>
            </td>
        `;
    ...
    this.containerElement.appendChild(listContainer);
}
...
document.addEventListener('DOMContentLoaded', () => {
    const paginationInstance = new ServerSidePagination({
        ...
        bearerToken: 'eyJhbGciOiJSUzI1NiIsImtpZCI6IjNmZDA3MmRmYTM4MDU2NzlmMTZmZTQxNzM4YzJhM2FkM2Y5MGIyMTQiLCJ0eXAiOiJKV1QifQ..JRIdHv6yoaXTreH9_p2jGg_AFcvq2vdDjVMWFLeqlYIExUL5zgDNm5H2DZyy3FD9WROlrLB_op2W-cKQQAkEV3ASvOmyS_PSb5CiF2jdNcxgT7mG5cc3OjW9fqrt5EftrpKiL3qSBrRBmLiO1RrRr5qmgaFCezSlXfm_3-sUoaDbR89mG5645IIJJZH0GfphtItMdd-TnjL94FlT5QtaN9p05JC_SxhOggydTfGGIbyZ5bCXQXlLUIBC90V1MsJWN1N64SjHj7tGo9IboejhRkrvpHpHFK-yKhi9MLwDPvzVVgH22em7oFhjY68S_mgd92dR9_YeesredokbNlgong',
        domainId: 'thetorchguys.com',
        recommendationType: 'PAGEFIXES',
        containerElement: document.getElementById('page-container'),
        paginationElement: document.getElementById('page-pagination-controls'),
